...
import com.pultec.undertalebnprework.RunnerFacebook;
import com.pultec.undertalebnprework.DemoGLSurfaceView;
...
import com.pultec.undertalebnprework.ISocial;
import com.pultec.undertalebnprework.IAdExt;
...
//    public static native void OnKakaoMessageResult(int _id, int _statusCode,String _msg);
 ...
 //   public static native void OnKakaoFriendsLoaded(String[] friends,String[] appfriends);
    ...
    public static void PlayMP3( String _mp3, int _loop ) {
    	...
    	try {
    		Class resRaw = Class.forName("com.pultec.undertalebnprework.R$raw");    		
	...
	*/
	...
	//	Log.i("yoyo","Java side attempting to call extension function " + methodname + " on class " + classname); 
		try{
			...
			try{
				ReqClass = Class.forName("com.pultec.undertalebnprework."+classname);
			}
			catch (ClassNotFoundException e)
			{
				Log.i("yoyo","Extension Class not found: " + "com.pultec.undertalebnprework."+classname + " attempting to call " + methodname);
			}
	...
	public static void ShowMessage(String _message ) {
    	...
    	RunnerActivity.ViewHandler.post( new Runnable() {
    		 public void run() {
    	    		AlertDialog.Builder builder = new AlertDialog.Builder(ms_context, R.style.Theme_Material3AlertDialog);
	...
	public static String InputString( String _message, String _default ) {
    	...
    	{
    		 public void run() {
    	    		AlertDialog.Builder builder = new AlertDialog.Builder(ms_context, R.style.Theme_Material3DialogEditText);
